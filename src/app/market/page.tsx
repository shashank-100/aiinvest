...
const marketViews = [
  ...
  { label: "By Sector", href: "/market/stocks-usa/sector", icon: "🏭" },
  { label: "By Industry", href: "/market/stocks-usa/industry", icon: "🏗️" },
  { label: "By Sub-Industry", href: "/market/stocks-usa/subindustry", icon: "🔬" },
];
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mb-12">
        {marketViews.map((v) => (
          <Link
            key={v.label}
            href={v.href}
            className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl p-4 text-center hover:border-[#00d4aa] hover:text-[#00d4aa] transition-colors"
          >
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
        {sectors.map((s) => {
          ...
          return (
            <Link
              key={s}
              href={`/market/stocks-usa/sector/${slug}`}
